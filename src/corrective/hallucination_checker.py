...
class HallucinationChecker:
    ...
    def check(self, documents: list[Document], generation: str) -> bool:
        ...
        try:
            ...
            result = self.chain.invoke({"documents": docs_content, "generation": generation})
    ...
    def check_with_reasoning(self, documents: list[Document], generation: str) -> tuple[bool, str]:
        ...
        try:
            ...
            result = chain.invoke({"documents": docs_content, "generation": generation})
            ...
            is_grounded = (
                ...
                and "HALLUCINATED" not in response.split("Verdict:")[-1].upper()
            )
