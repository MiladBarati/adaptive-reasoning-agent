...
class TestRAGWorkflow:
    ...
    def test_query_rag_agent_full_workflow(
        ...
        for mock_groq in [mock_verifier_groq, mock_checker_groq, mock_grader_groq, 
                          mock_rewriter_groq, mock_nodes_groq, mock_retriever_groq]:
    ...
    def test_rag_workflow_web_search_fallback(
        self,
        mock_tavily_client,
